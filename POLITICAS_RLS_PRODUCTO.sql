...
-- 2. Los usuarios solo puedan ver productos de su organización
-- 3. Solo el ADMINISTRADOR de la organización (y SUPERADMIN) puede crear/actualizar (administrar) productos
-- 4. La eliminación es "soft delete" (cambia estadoProducto a false) mediante UPDATE
-- =====================================================
...
DROP POLICY IF EXISTS "Admins pueden crear productos de su organización" ON "PRODUCTO";
DROP POLICY IF EXISTS "Admins pueden actualizar productos de su organización" ON "PRODUCTO";
...
-- =====================================================
-- POLÍTICA 3: Solo ADMINISTRADOR de la organización (y SUPERADMIN) pueden crear productos
-- =====================================================
CREATE POLICY "Admins pueden crear productos de su organización"
ON "PRODUCTO"
FOR INSERT
TO authenticated
WITH CHECK (
...
-- =====================================================
-- POLÍTICA 4: Solo ADMINISTRADOR de la organización (y SUPERADMIN) pueden actualizar productos
-- =====================================================
CREATE POLICY "Admins pueden actualizar productos de su organización"
ON "PRODUCTO"
FOR UPDATE
TO authenticated
USING (
...
-- NOTAS
-- =====================================================
-- 1. Los superadmins tienen acceso completo (CRUD) sobre PRODUCTO
-- 2. Los usuarios normales solo pueden ver productos activos de su propia organización
-- 3. Solo el rol ADMINISTRADOR (de la organización) puede crear/actualizar productos de su organización
-- 4. La eliminación lógica (soft delete) se implementa marcando estadoProducto = false vía UPDATE
